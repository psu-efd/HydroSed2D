...
!   This subroutine hardwire the bed elevation according to
!   some functions. For real engineering applications, it might
!   need to interpolate the bed elevation according to DEM file.
!   See the documentation for other tools
!   Here are some cases which are used as examples. Uncomment
!   the part as needed.
...
!		   pcoor(i,3)=sin(3.1415926*(pcoor(i,1)-500.0)/200.0)**2*sin(3.1415926*(pcoor(i,2)-400.0)/200.0)**2
!		end if
!	enddo 
